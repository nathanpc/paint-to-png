...
public class MySpotDrawer : MonoBehaviour {

    public Material drawingMat;
    
    public float intencity = 1f;
    public Color color = Color.white;
    [Range(0.01f, 90f)] public float angle = 10f;
    public float range = 10f;
    public Texture cookie;
    public int shadowMapResolution = 1024;

    [SerializeField] private ParticleSystem sprayPaint;
    ...
    public void Draw(MyDrawable drawable)
    {
